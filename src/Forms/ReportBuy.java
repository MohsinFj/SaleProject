 ...
 * @author Mohammad
 */
public class ReportBuy extends javax.swing.JFrame {
    ...
    public ReportBuy(String id) {
        initComponents();
        
        String sql1 = "SELECT ProviderID,TotalPrice,PaidPrice,Debt FROM importt WHERE ID = '" + id + "'";
        String exportInfo[] = go.GetInformation(sql1,5);
        
        String PName = exportInfo[0];
        String total = exportInfo[1];
        String paid = exportInfo[2];
        String debt = exportInfo[3];
        
        String sql2 = "SELECT Name FROM provider WHERE ID = '" + PName + "'";
        ...
        fillTable("SELECT importt.Date,CONCAT('$ ', FORMAT(importtitem.Price, 0)),importtitem.Quantity,material.Name FROM importt JOIN importtitem JOIN material WHERE importt.ID = importtitem.ImportID AND importtitem.MateriaID = material.ID AND importtitem.ImportID = "+id+" ORDER BY importt.ID ASC", tblBuy);
    ...
    private void fillText(JLabel text , String value )
    {
    ...
    private void initComponents() {
        ...
        tblBuy.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "التاريخ", "سعر الشراء", "كمية البيع", "اسم المادة"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportBuy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
