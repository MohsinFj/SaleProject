...
public class AddType extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAddEditItem.setText("اضافة مجموعة");
        jPanel2.add(lblAddEditItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, 35));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "الرجاء ملئ حقل المجموعة");
        }
        else
        {
            ...
            go g = new go();
            String sql = "INSERT INTO grop(`Name`) VALUES " + "('" + name + "')";
            g.query(sql);
