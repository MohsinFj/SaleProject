...
public class AddProvider extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAddEditItem.setText("اضافة مزود");
        ...
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 30, 90, 30));

        txtName.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtName.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtName.setMargin(new java.awt.Insets(2, 2, 2, 5));
        jPanel3.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 220, 30));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("العنوان:");
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 90, 60, 30));
        ...
        jPanel3.add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 220, 30));
        ...
        jPanel3.add(btnAdd1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 220, 180, 40));

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("رقم الهاتف:");
        jPanel3.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 150, 70, 30));
        ...
        jPanel3.add(txtPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 220, 30));
    ...
    private void btnAdd1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd1ActionPerformed
        ...
        else
        {
            ...
            String sql1 = "SELECT ID FROM provider WHERE Name = '" + name + "'";
            String id = go.getData(sql1);
            if(!id.equals(""))
            {
                JOptionPane.showMessageDialog(null, "اسم المزود موجود");
                txtName.setText("");
                txtName.requestFocus();
                return;
            }
            
            String sql2 = "INSERT INTO provider(Name , Address , Phone, Debt) VALUES "
    ...
    private void txtPhoneKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPhoneKeyReleased
        ...
        if(!text.equals(""))
        {
            ...
            {
                txtPhone.setText(""+text.substring(0, text.length()- 1));
                return;
            }
            if(!Character.isDigit(text.charAt(0)))
            {
                txtPhone.setText(""+text.substring(1));
                return;
            }
            if(text.length() > 15)
            {
